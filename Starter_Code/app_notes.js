...
function metaData(sample){
    // read .json file and create varialbles 
    d3.json("data/samples.json").then((data) => {
        var metaData = data.metadata; // master key of array
        var resultArray = metaData.filter(object => object.id==sample); //dropdown values
        var result = resultArray[0]; 
        var sampleData = d3.select("#sample-metadata"); //correlate sample data to <div id="sample-metadata"> in .html
        sampleData.html("");
